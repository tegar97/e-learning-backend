            ...
            <PostBoxBody>
                ...
                <React.Fragment>
                    ...
                    {imageType.includes(file.split('.').pop().toLowerCase()) ?
                     <img src={ `https://e-learning-backend.tegar.me/images/${file}` } alt="image" width="100%" height="400" style={{objectFit: 'cover'}}/>
                    : file ?
                     <PostFileContainer>
                        <FileCopyIcon/>
                        <p style={{marginRight: 'auto'}}>{file}</p>
                        <a download href={`https://e-learning-backend.tegar.me/images/${file}`}>download</a>
                     </PostFileContainer>   
                    :
                    ''
                    }
