            ...
            <PostBoxBody>
                ...
                <React.Fragment>
                    ...
                    {imageType.includes(file.split('.').pop().toLowerCase()) ?
                     <img src={ `http://147.139.173.23:5000/images/${file}` } alt="image" width="100%" height="400" style={{objectFit: 'cover'}}/>
                    : file ?
                     <PostFileContainer>
                        <FileCopyIcon/>
                        <p style={{marginRight: 'auto'}}>{file}</p>
                        <a download href={`http://147.139.173.23:5000/images/${file}`}>download</a>
                     </PostFileContainer>   
                    :
                    ''
                    }
